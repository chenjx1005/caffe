...
class BiClassifyAccuracyLayer : public Layer<Dtype> {
 public:
  explicit BiClassifyAccuracyLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  ...
  virtual inline const char* type() const { return "BiClassifyAccuracy"; }
